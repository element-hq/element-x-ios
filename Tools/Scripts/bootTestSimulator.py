...
for device in devices:
    if device['name'] == simulator_name:
        ...
        os.system("/usr/bin/xcrun simctl status_bar '" + UDID + "' override --time '2007-01-09T08:41:00+01:00' --dataNetwork 'wifi' --wifiMode 'active' --wifiBars 3 --cellularMode 'active' --cellularBars 4 --batteryState 'charged' --batteryLevel 100 > /dev/null 2>&1")
