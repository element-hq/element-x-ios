...
//        return MockServerSelectionScreenState.self
//    }
//
//    override class func createTest() -> MockScreenTest {
//        return ServerSelectionUITests(selector: #selector(verifyServerSelectionScreen))
//    }
//
//    func verifyServerSelectionScreen() throws {
//        guard let screenState = screenState as? MockServerSelectionScreenState else { fatalError("no screen") }
//        switch screenState {
//        case .matrix:
//            verifyNormalState()
//        case .emptyAddress:
...
//        let textFieldFooter = app.staticTexts["textFieldFooter"]
//        XCTAssertTrue(textFieldFooter.exists)
//        XCTAssertEqual(textFieldFooter.label, ElementL10n.unknownError)
//    }
//    
