...
struct CollapsibleRoomTimelineView_Previews: PreviewProvider, TestablePreview {
    static let item = CollapsibleTimelineItem(items: [
        SeparatorRoomTimelineItem(id: .init(uniqueID: .init(id: "First separator")), text: "This is a separator"),
        SeparatorRoomTimelineItem(id: .init(uniqueID: .init(id: "Second separator")), text: "This is another separator")
    ])
