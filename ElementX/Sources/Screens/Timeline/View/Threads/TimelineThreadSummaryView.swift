...
struct TimelineThreadSummaryView: View {
    ...
    private var content: some View {
        if let content = threadSummary?.lastMessageContent, let senderID = threadSummary?.senderID {
            switch content {
            case .message(let content):
                switch content {
                case .audio(let content):
                    ThreadView(senderID: senderID,
                               sender: threadSummary?.sender,
...
struct TimelineThreadSummaryView_Previews: PreviewProvider, TestablePreview {
    ...
    static var previewItems: [TimelineThreadSummaryView] {
        [
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .message(.text(.init(body: "This is a threaded message"))))),
            
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .message(.notice(.init(body: "Hello world"))))),
            
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .message(.audio(.init(filename: "audio.m4a",
                                                                                                     caption: "Some audio",
                                                                                                     duration: 0,
                                                                                                     waveform: nil,
                                                                                                     source: nil,
            ...
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .message(.file(.init(filename: "file.txt",
                                                                                                    caption: "Some file",
                                                                                                    source: nil,
                                                                                                    fileSize: nil,
                                                                                                    thumbnailSource: nil,
            ...
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .message(.image(.init(filename: "image.jpg",
                                                                                                     caption: "Some image",
                                                                                                     imageInfo: .mockImage,
            ...
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .message(.video(.init(filename: "video.mp4",
                                                                                                     caption: "Some video",
                                                                                                     videoInfo: .mockVideo,
            ...
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .message(.location(.init(body: ""))))),
            
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .message(.voice(.init(filename: "voice-message.ogg",
            ...
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .poll(question: "Do you like polls?"))),
            ...
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .message(.notice(.init(body: "", formattedBody: attributedStringWithMention))))),
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .message(.notice(.init(body: "", formattedBody: attributedStringWithAtRoomMention))))),
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .message(.notice(.init(body: "", formattedBody: attributedStringWithRoomAliasMention))))),
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .message(.notice(.init(body: "", formattedBody: attributedStringWithRoomIDMention))))),
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .message(.notice(.init(body: "", formattedBody: attributedStringWithEventOnRoomIDMention))))),
            TimelineThreadSummaryView(threadSummary: .init(senderID: "@alice:matrix.org",
                                                           sender: .init(id: "@alice:matrix.org",
                                                                         displayName: "Alice"),
                                                           lastMessageContent: .message(.notice(.init(body: "", formattedBody: attributedStringWithEventOnRoomAliasMention)))))
        ]
    }
