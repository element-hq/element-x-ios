...
class SessionVerificationScreenStateMachine {
    ...
    private func configure() {
        stateMachine.addRoutes(event: .acceptVerification, transitions: [.initial => .acceptingRequest])
        stateMachine.addRoutes(event: .requestVerification, transitions: [.initial => .requestingVerification])
        
        stateMachine.addRoutes(event: .didAcceptVerificationRequest, transitions: [.acceptingRequest => .verificationRequestAccepted,
