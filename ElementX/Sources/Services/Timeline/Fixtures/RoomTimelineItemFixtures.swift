...
enum RoomTimelineItemFixtures {
    ...
    static var `default`: [RoomTimelineItemProtocol] = [
        ...
        TextRoomTimelineItem(id: .random,
                             ...
                             sender: .init(id: "", displayName: "Helena"),
                             content: .init(body: "",
                                            formattedBody: AttributedStringBuilder(permalinkBaseURL: ServiceLocator.shared.settings.permalinkBaseURL, mentionsEnabled: ServiceLocator.shared.settings.mentionsEnabled).fromHTML("Hol' up <blockquote>New home office set up!</blockquote>That's amazing! Congrats 🥳")))
    ]
