...
enum RoomTimelineItemFixtures {
    ...
    static var `default`: [RoomTimelineItemProtocol] = [
        ...
        TextRoomTimelineItem(id: .init(timelineID: ".RoomTimelineItemFixtures.default.01",
                                       eventID: "RoomTimelineItemFixtures.default.0"),
                             timestamp: "10:10 AM",
                             isOutgoing: false,
                             isEditable: false,
                             ...
                             isThreaded: false,
                             sender: .init(id: "", displayName: "Jacob"),
                             content: .init(body: "Some historical message"),
                             properties: RoomTimelineItemProperties(shield: MessageShield(color: .RED, message: "Encrypted by a device not verified by it's owner"))),
