...
struct RoomTimelineItemFactory: RoomTimelineItemFactoryProtocol {
    ...
    private func buildMessageTimelineItem(_ eventItemProxy: EventTimelineItemProxy,
        ...
        case .gallery(let galleryMessageContent):
            return buildGalleryTimelineItem(for: eventItemProxy, messageLikeContent, messageContent, galleryMessageContent, isOutgoing, repliedToEvent)
        case .other:
            return nil
        }
    }
    ...
    private func buildTimelineItemReplyDetails(_ details: MatrixRustSDK.InReplyToDetails?,
                                               repliedToEvent: EventTimelineItemProxy?) -> TimelineItemReplyDetails? {
        guard let details else {
            return nil
        }
        
        return buildTimelineItemReply(details, repliedToEvent: repliedToEvent).details
    }
