...
//        }
    ...
    private func fetchRoomDetails(mainRoom: Room, previewRoom: Room?) -> (mainRoomInfo: RoomInfo, previewRoomInfo: RoomInfo?, latestEvent: EventTimelineItem?) {
        class FetchResult {
        ...
        Task {
            do {
                ...
                if let previewRoom {
                    ...
                    result.latestEvent = await previewRoom.latestEvent()
                }
