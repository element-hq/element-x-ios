...
class ClassicAppAccountManager {
    ...
    func storePath(for userID: String) -> URL {
        cacheFolder.appending(component: Self.kMXFileStoreFolder).appending(component: userID)
    }
    ...
    private func activeAccount(mxAccount: ClassicAppMXAccount) -> ClassicAppAccount? {
        ...
        return ClassicAppAccount(userID: userID, serverName: serverName, cryptoStoreURL: cryptoStoreURL(for: userID))
    }
