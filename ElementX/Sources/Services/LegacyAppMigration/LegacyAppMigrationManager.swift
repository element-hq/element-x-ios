...
protocol LegacyAppMigrationManagerProtocol { }

final class LegacyAppMigrationManager: LegacyAppMigrationManagerProtocol {
    ...
    init(userID: String, legacyKeychainServiceName: String, legacyAccessGroup: String) {
        self.userID = userID
        self.legacyAccessGroup = legacyAccessGroup
        keychain = Keychain(service: legacyKeychainServiceName, accessGroup: legacyAccessGroup)
    }
