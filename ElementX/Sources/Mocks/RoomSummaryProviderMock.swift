...
extension Array where Element == RoomSummary {
    static let mockRooms: [Element] = [
        .filled(details: RoomSummaryDetails(roomListItem: RoomListItemSDKMock(),
                                            id: "1",
                                            isInvite: false,
                                            inviter: nil,
                                            name: "Foundation 🔭🪐🌌",
            ...
            for hasUnreadMessages in [false, true] {
                ...
                for hasUnreadMentions in [false, true] {
                    ...
                    for hasUnreadNotifications in [false, true] {
                        ...
                        let room = RoomSummary.filled(details: RoomSummaryDetails(roomListItem: RoomListItemSDKMock(),
                                                                                  id: "\(id)",
                                                                                  settingsMode: mode,
