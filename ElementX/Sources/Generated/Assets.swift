...
internal enum Asset {
  internal enum Colors {
    ...
    internal static let zeroChatBubbleIncoming = ColorAsset(name: "colors/zero-chat-bubble-incoming")
  ...
  internal enum Images {
    ...
    internal static let backgroundLanding = ImageAsset(name: "images/background-landing")
    ...
    internal static let btnCreateAccount = ImageAsset(name: "images/btn_create_account")
    ...
    internal static let frameRewardsVector = ImageAsset(name: "images/frame-rewards-vector")
    internal static let frameZeroCard = ImageAsset(name: "images/frame-zero-card")
    ...
    internal static let iconZChain = ImageAsset(name: "images/icon-z-chain")
    ...
    internal static let imgReferFriend = ImageAsset(name: "images/img-refer-friend")
    internal static let imgZeroProSub = ImageAsset(name: "images/img-zero-pro-sub")
