...
extension AccessibilityTests {
    ...
    func testInviteFriendSettingsScreen() async throws {
        try await performAccessibilityAudit(named: "InviteFriendSettingsScreen_Previews")
    }
    ...
    func testUserRewardsSettingsScreen() async throws {
        try await performAccessibilityAudit(named: "UserRewardsSettingsScreen_Previews")
    }
