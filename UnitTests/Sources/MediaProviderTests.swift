...
private enum MediaProxyMockError: Error {
    case someError
}

private class MediaProxyMock: MediaProxyProtocol {
...
private enum FileCacheMockError: Error {
    case someError
}

private class FileCacheMock: FileCacheProtocol {
    var fileKey: String?
