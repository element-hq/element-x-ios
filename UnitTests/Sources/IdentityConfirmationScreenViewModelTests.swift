...
@MainActor
class IdentityConfirmationScreenViewModelTests: XCTestCase {
    var viewModel: IdentityConfirmationScreenViewModelProtocol!
    
    var context: IdentityConfirmationScreenViewModelType.Context {
        viewModel.context
    }
