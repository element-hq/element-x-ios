...
| Маркетинговый URL | `https://www.ucmeet.info` | 🟢 |
| Юридическое лицо | UC.Technology LLC | 🟢 |
| Субтитр App Store | ⬜ ожидает выбора заказчика (лимит 30 символов) | 🟡 |
...
| 2026-03-22 | D-009 обновлён: URL-адреса получены от заказчика — Privacy (`privacy-security`), Support (`support`), Terms (`ucmeetchat-terms-of-use`), Marketing (`ucmeet.info`). Юрлицо: UC.Technology LLC. Субтитр App Store ожидает выбора (лимит 30 символов). |
